...
var PORTAL_PAGE_HTML = [
  ...
  "/* One box instead of a list. Native <select> on purpose: on a phone that is\n",
  "   the platform's own picker, which beats anything built here, and it costs\n",
  "   one line of screen no matter how many names are in it. */\n",
  ".pick{display:block;width:100%;appearance:none;-webkit-appearance:none;-moz-appearance:non",
  "e;\n",
  "  background-color:var(--paper);color:inherit;border:1px solid var(--line);border-radius:9",
  "px;\n",
  "  padding:14px 40px 14px 14px;font:inherit;cursor:pointer;margin-bottom:10px;min-height:50",
  "px;\n",
  ...
  "%237b8798' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E\")",
  ";\n",
  "  background-repeat:no-repeat;background-position:right 15px center;background-size:12px 8",
  "px;}\n",
